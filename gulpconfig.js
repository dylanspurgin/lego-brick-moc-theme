...
// Project paths
var theme       = 'lego-brock-moc', // The directory name for your theme; change this at the very least!
...
module.exports = {
    ...
    browsersync: {
        ...
        port: 3002, // Port number for the live version of the site; default: 3000
        proxy: 'localhost:8082', // We need to use a proxy instead of the built-in server because WordPress has to do some server-side rendering for the theme to work
        watchOptions: {
